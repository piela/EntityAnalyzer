...
namespace Flexix\SanboxBundle\Controller;
...
class TestController extends Controller {
    ...
    public function testAction(Request $request) {
        ...
        $response=$this->get('flexix_prototype.prototype_controller')->newAction($request);
        $response2=$this->get('flexix_prototype.prototype_controller')->getAction($request,6);
        $response3=$this->get('flexix_prototype.prototype_controller')->editAction($request,6);
        $response4=$this->get('flexix_prototype.prototype_controller')->listAction($request,6);

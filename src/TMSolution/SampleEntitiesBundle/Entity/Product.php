...
class Product {
    ...
    /**
     * @var TMSolution\SampleEntitiesBundle\Entity\ProductDefinition
     *
     * @ORM\ManyToOne(targetEntity="TMSolution\SampleEntitiesBundle\Entity\ProductDefinition")
     * @ORM\JoinColumns({
    ...
    /**
     * @var TMSolution\SampleEntitiesBundle\Entity\Transaction
     *
     * @ORM\ManyToOne(targetEntity="TMSolution\SampleEntitiesBundle\Entity\Transaction",inversedBy="products")
     * @ORM\JoinColumns({
    ...
    /**
     * @var TMSolution\SampleEntitiesBundle\Entity\PaymentFrequency
     *
     * @ORM\ManyToOne(targetEntity="TMSolution\SampleEntitiesBundle\Entity\PaymentFrequency")
     * @ORM\JoinColumns({
     ...
     * Set transaction
     *
     * @param \TMSolution\SampleEntitiesBundle\Entity\Transaction $transaction
     * @return Product
     */
    public function setTransaction(\TMSolution\SampleEntitiesBundle\Entity\Transaction $transaction = null) {
     ...
     * Get transaction
     *
     * @return \TMSolution\SampleEntitiesBundle\Entity\Transaction 
     */

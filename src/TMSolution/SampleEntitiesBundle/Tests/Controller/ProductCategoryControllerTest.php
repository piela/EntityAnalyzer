...
namespace TMSolution\SampleEntitiesBundle\Tests\Controller;
...
class ProductCategoryControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $form = $crawler->selectButton('Create')->form(array(
            'tmsolution_sampleentitiesbundle_productcategory[field_name]'  => 'Test',
        ...
        $form = $crawler->selectButton('Update')->form(array(
            'tmsolution_sampleentitiesbundle_productcategory[field_name]'  => 'Foo',
            // ... other fields to fill
        ));
